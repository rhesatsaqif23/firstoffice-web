...
import OfficeFeatures from "@/src/features/offices/components/OficeFeatures";
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-extrabold text-[32px] leading-[44px]">
                {office.title} <br /> Master Capitalize
              </h1>
          ...
          <div className="flex flex-col rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
            ...
            <div className="flex flex-col gap-[14px]">
              {office.isFullyBooked ? (
                ...
                <a
                  target="blank"
                  href={`https://wa.me/628123123123?text=${encodeURIComponent(`Saya ingin booking kantor ${office.title} detailsnya http://localhost:3000/office/${office.slug}`)}`}
